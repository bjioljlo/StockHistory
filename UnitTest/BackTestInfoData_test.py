...
class BackTestInfoDataPriceByToday_test(unittest.TestCase):
    def setUp(self) -> None:
        self._BaseInfoData = BaseInfoData(5000000, datetime.strptime('2020-03-06', '%Y-%m-%d'), datetime.strptime('2021-03-04', '%Y-%m-%d'))
    ...
    def test_RecordUserInfo(self):
        ...
        self.assertEqual(self.BackTestInfoDataPriceByToday_test._TempTradeInfo.Data["號碼"][datetime.strptime('2020-03-06', '%Y-%m-%d')], "2330")
        self.assertAlmostEqual(self.BackTestInfoDataPriceByToday_test._TempResultAll.Data["股票資產"][datetime.strptime('2020-03-06', '%Y-%m-%d')]/1000, 303.793091)